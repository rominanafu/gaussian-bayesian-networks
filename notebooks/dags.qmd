...
```{r}
dag2 = model2network("[so_2][nox][pm_0_10][pm_2_5][nh_3][edad][pcr|so_2:nox:pm_0_10:pm_2_5:nh_3:edad][ac_urico|so_2:nox:pm_0_10:pm_2_5:nh_3:edad][ferritina|so_2:nox:pm_0_10:pm_2_5:nh_3:edad]")
...
mod_gam_pcr = gam(pcr ~ s(so_2) + s(nox) + s(pm_2_5) + s(pm_0_10) + s(nh_3), data=data, method="REML")
mod_gam_ac_urico = gam(ac_urico ~ s(so_2) + s(nox) + s(pm_2_5) + s(pm_0_10) + s(nh_3), data=data, method="REML")
mod_gam_ferritina = gam(creat ~ s(so_2) + s(nox) + s(pm_2_5) + s(pm_0_10) + s(nh_3), data=data, method="REML")
```
